...
const FormElementEmailMIMEPart: React.FC<Props> = ({ emailMIMEPart, emailMIMEPartIndex, property }) => {
    ...
    selectedSTIXObject && (
      <div className="w-full">
        ...
        <FormElementTextInput
          ...
          additionalInputClasses="select-sm dark:bg-neutralc-900"
          additionalLabelClasses="ml-6 mr-5 w-20"
          showValidationError={emailMIMEPart.body_raw_ref ? !stixIdentifierValidator(emailMIMEPart.body_raw_ref) : false}
          validationErrorText={`The identifier is not valid.
