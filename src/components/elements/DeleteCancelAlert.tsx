...
export const DeleteCancelAlert: React.FC<DeleteCancelAlertProps> = ({
  ...
  return (
    <div
      role="alert"
      className={`alert ${className} text-base text-neutralc-900 bg-warning-light border-primary-900 dark:bg-warning-dark dark:text-neutralc-100 dark:border-primary-100`}
    >
      <svg
      ...
      <ButtonBasic label={'Delete'} type={'btn-primary'} additionalClasses={`${'btn-sm'}`} onClick={onDeleteClick} />
