  ...
  classes: [
    {
      ...
      properties: [
        ...
        { name: 'confidence', type: 'Integer', min: 0, max: 100, collate: 'default' },
    ...
    },
    {
      ...
      properties: [
        ...
        { name: 'sighting_of_ref', type: 'String', mandatory: true, notNull: true, collate: 'default' },
    ...
    },
    {
      ...
      properties: [
        { name: 'hashes', type: 'EmbeddedMap', collate: 'default' },
        { name: 'size', type: 'Integer', min: 0,  collate: 'default' },
        { name: 'name', type: 'String', collate: 'default' },
    ...
    },
    {
      ...
      properties: [
        ...
        { name: 'src_port', type: 'Integer', min: 0, max: 65535, collate: 'default' },
        { name: 'dst_port', type: 'Integer', min: 0, max: 65535, collate: 'default' },
        { name: 'protocols', type: 'EmbeddedList', collate: 'default', mandatory: true },
        { name: 'src_byte_count', type: 'Integer', min: 0, collate: 'default' },
        { name: 'dst_byte_count', type: 'Integer', min: 0, collate: 'default' },
        { name: 'src_packets', type: 'Integer', min: 0, collate: 'default' },
        { name: 'dst_packets', type: 'Integer', min: 0, collate: 'default' },
    ...
    },
    {
      ...
      properties: [
        ...
        { name: 'number_observed', type: 'Integer', min: 1, mandatory: true, notNull: true, collate: 'default' },
    ...
    },
    {
      ...
      properties: [
        ...
        { name: 'creator_user_ref', type: 'String', collate: 'default' },
        { name: 'number_of_subkeys', type: 'Integer', min: 0, collate: 'default' }
      ]
    },
    {
