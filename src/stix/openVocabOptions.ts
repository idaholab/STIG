...
const attack_resource_level_ov = ['individual', 'club', 'contest', 'team', 'organization', 'government'];

const grouping_context_ov = ['suspicious-activity', 'malware-analysis', 'unspecified'];

const hash_algorithm_ov = ['MD5', 'SHA-1', 'SHA-256', 'SHA-512', 'SHA3-256', 'SHA3-512', 'SSDEEP', 'TLSH'];

const identity_class_ov = ['individual', 'group', 'system', 'organization', 'class', 'unknown'];
...
const malware_result_ov = ['malicious', 'suspicious', 'benign ', 'unknown'];
...
const pattern_type_ov = ['stix', 'pcre', 'sigma', 'snort', 'suricata', 'yara'];

const processor_architecture_ov = ['alpha', 'arm', 'ia-64', 'mips', 'powerpc', 'sparc', 'x86', 'x86-64'];
...
const threat_actor_sophistication_ov = ['none', 'minimal', 'intermediate', 'advanced', 'expert', 'innovator', 'strategic'];
