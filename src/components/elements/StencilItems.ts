...
export const stencilItems: StencilItem[] = [
    ...
    { id: 'extension-definition', imageUrl: '/stig/stencils/smo/20-50360_r3_ExtensionDefinitions-Square.png', alt: 'Extension Definition', type: 'smo' },
    { id: 'language-content', imageUrl: '/stig/stencils/smo/language-square-flat-300-dpi.png', alt: 'Language Content', type: 'smo' },
    { id: 'marking-definition', imageUrl: '/stig/stencils/smo/20-50360_r1_MarkingDefinition-Square.png', alt: 'Marking Definition', type: 'smo' },
];
