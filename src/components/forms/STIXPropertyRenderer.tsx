...
export function STIXPropertyRenderer({
  property,
  showTypeSelector,
  onTypeChange,
  ...
  switch (property.name) {
    ...
    case 'relationship_type':
      return (
        <FormElementSelect
          value={selectedSTIXObject && 'relationship_type' in selectedSTIXObject ? selectedSTIXObject.relationship_type : ''}
        ...
        case 'boolean':
          return (
            <FormElementSelect
              placeholder=""
              value={
                selectedSTIXObject && selectedSTIXObject[property.name] !== undefined ? selectedSTIXObject[property.name] : ''
              }
              options={['true', 'false']}
              onChange={(event) => {
                handlePropertyUpdate(
