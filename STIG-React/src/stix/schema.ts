...
export const schema: SchemaSTIXClass[] = [
  ...
  },
  {
    ...
    properties: [
      ...
      { name: 'version', type: 'string', mandatory: true, notNull: true },
      {
        ...
        type: 'list',
        listType: 'enum',
        enumType: 'extension-type-enum',
        mandatory: true,
        notNull: true,
        default: [enum_options['extension-type-enum'][0]],
      },
  ...
  },
  {
    ...
    superClasses: ['cyber-observable-core'],
    properties: [{ name: 'value', type: 'string', mandatory: true, notNull: true }],
  },
  {
    name: 'malware',
    description:
  ...
  },
  {
    ...
    superClasses: ['cyber-observable-core'],
    properties: [{ name: 'name', type: 'string', mandatory: true, notNull: true }],
  },
  {
