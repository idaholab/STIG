...
const FormElementSTIXX509V3Extensions: React.FC<Props> = ({ property }) => {
  ...
  const x509V3ExtensionsTimestampProperties = ['private_key_usage_period_not_before', 'private_key_usage_period_not_after'];
      ...
      <div className="w-full mb-2">
        ...
        {x509V3ExtensionsStringProperties.map((x509V3ExtensionsProperty, i) => (
          <FormElementTextInput
            ...
            type="text"
            value={selectedSTIXObject[property.name] ? (selectedSTIXObject[property.name][x509V3ExtensionsProperty] ?? '') : ''}
            onChange={(event) => {
