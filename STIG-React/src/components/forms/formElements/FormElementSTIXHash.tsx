...
const FormElementSTIXHash: React.FC<Props> = ({ hashAlgName, property }) => {
    ...
    selectedSTIXObject && (
      <div className="w-full">
        <FormElementSelectOther
          ...
          onSelect={(event) => {
            handleHashNameUpdate(event.target.value, hashAlgName, property.name, selectedSTIXObject, setSelectedSTIXObject);
          }}
          onInputChange={(event) => {
            handleHashNameUpdate(event.target.value, hashAlgName, property.name, selectedSTIXObject, setSelectedSTIXObject);
          }}
          onSwitchToSuggested={() => {
            handleHashNameUpdate('', hashAlgName, property.name, selectedSTIXObject, setSelectedSTIXObject);
          }}
        ...
        <FormElementTextInput
          ...
          validationErrorText={`The hash key is not valid. 
