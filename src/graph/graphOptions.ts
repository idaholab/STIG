...
import { LayoutOptions, RandomLayoutOptions } from 'cytoscape';
...
export let modified_select_style: cytoscape.Stylesheet = {
...
export let view_utils_options: ViewUtilitiesOptions = {
    node: {
        highlighted: {
            'border-color': '#1E90FF',
            'border-style': 'solid',
...
export let cola_layout_options: IColaLayoutOptions = {
    name: 'cola',
    ...
    ready: () => { return; }, // on layoutreadycytoscape_vie
    stop: () => { return; }, // on layoutstop
...
export let cose_bilkent_options = {
    name: "cose-bilkent",
    // Called on `layoutready`
    ready: () => { return; },
    // Called on `layoutstop`
...
export let klay_options: cytoscape.KlayOptions = {
    name: 'klay',
...
export let spread_options: cytoscape.SpreadLayoutOptions = {
    name: 'spread',
    animate: true, // whether to show the layout as it's running
    ready: undefined, // Callback on layoutready
    stop: undefined, // Callback on layoutstop
...
export let random_options: RandomLayoutOptions = {
    name: 'random',
...
export let grid_options: cytoscape.GridLayoutOptions = {
    name: 'grid',
...
export let circle_options: cytoscape.CircleLayoutOptions = {
    name: 'circle',
    fit: true, // whether to fit the viewport to the graph
...
export let concentric_options: cytoscape.IConcentricLayoutOptions = {
    name: 'concentric',
    fit: true, // whether to fit the viewport to the graph
    padding: 30, // the padding on fit
    startAngle: 3 / 2 * Math.PI, // where nodes start in radians
...
export let breadthfirst_options: cytoscape.BreadthFirstLayoutOptions = {
    name: 'breadthfirst',
    fit: true, // whether to fit the viewport to the graph
...
export let dagre_options: any = {
    ...
    ready: () => { return; }, // on layoutready
    stop: () => { return; }, // on layoutstop
};

export let euler_options: any = {
    name: 'euler',
...
export interface LayoutsType {
    [k: string]: LayoutOptions;
}

export let layouts: LayoutsType = {
