...
export const stencilItems: StencilItem[] = [
  {
    id: 'attack-pattern',
    imageUrl: '/stig/stencils/sdo/attack-pattern-square-flat-300-dpi.png',
    alt: 'Attack Pattern',
    type: 'sdo',
  },
  ...
  {
    id: 'infrastructure',
    imageUrl: '/stig/stencils/sdo/infrastructure-square-flat-300-dpi.png',
    alt: 'Infrastructure',
    type: 'sdo',
  },
  {
    id: 'intrusion-set',
    imageUrl: '/stig/stencils/sdo/intrusion-set-square-flat-300-dpi.png',
    alt: 'Intrusion Set',
    type: 'sdo',
  },
  ...
  {
    id: 'malware-analysis',
    imageUrl: '/stig/stencils/sdo/malware-analysis-square-flat-300-dpi.png',
  ...
  {
    id: 'observed-data',
    imageUrl: '/stig/stencils/sdo/observed-data-square-flat-300-dpi.png',
    alt: 'Observed Data',
    type: 'sdo',
  },
  ...
  {
    id: 'vulnerability',
    imageUrl: '/stig/stencils/sdo/vulnerability-square-flat-300-dpi.png',
    alt: 'Vulnerability',
    type: 'sdo',
  },
  ...
  { id: 'artifact', imageUrl: '/stig/stencils/sco/20-50360_r1_Object-Artifact-Square.png', alt: 'Artifact', type: 'sco' },
  {
    ...
    imageUrl: '/stig/stencils/sco/autonomous-system-square-flat-300-dpi.png',
  ...
  {
    id: 'network-traffic',
    imageUrl: '/stig/stencils/sco/network-traffic-square-flat-300-dpi.png',
    alt: 'Network Traffic',
    type: 'sco',
  },
  ...
  { id: 'user-account', imageUrl: '/stig/stencils/sco/user-account-square-flat-300-dpi.png', alt: 'User Account', type: 'sco' },
  {
    ...
    imageUrl: '/stig/stencils/sco/20-50360_r1_Object-WindowsRegistryKey-Square.png',
    alt: 'Windows Registry Key',
    type: 'sco',
  },
  {
    id: 'x509-certificate',
    imageUrl: '/stig/stencils/sco/20-50360_r1_Object-X509Certificate-Square.png',
    alt: 'X509 Certificate',
    type: 'sco',
  },

  {
    id: 'extension-definition',
    imageUrl: '/stig/stencils/smo/20-50360_r3_ExtensionDefinitions-Square.png',
    alt: 'Extension Definition',
    type: 'smo',
  },
  {
    id: 'language-content',
    imageUrl: '/stig/stencils/smo/language-square-flat-300-dpi.png',
    alt: 'Language Content',
    type: 'smo',
  },
  {
    id: 'marking-definition',
    imageUrl: '/stig/stencils/smo/20-50360_r1_MarkingDefinition-Square.png',
    alt: 'Marking Definition',
    type: 'smo',
  },
];
