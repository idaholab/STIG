...
*/
 ...
 export interface IColaLayoutOptions {
    ...
    edgeSymDiffLength?: undefined | any; // symmetric diff edge length in simulation
    edgeJaccardLength?: undefined | any; // jaccard edge length in simulation

    // iterations of cola algorithm; uses default values on undefined
    unconstrIter?: undefined | any; // unconstrained initial layout iterations
    userConstIter?: undefined | any; // initial layout iterations with user-specified constraints
    allConstIter?: undefined | any; // initial layout iterations with all constraints including non-overlap
