...
const STIXPropertyLabel = forwardRef<HTMLParagraphElement, Props>(
  ({ propName, propertyType, showTypeSelector, onTypeChange, additionalLabelClasses, includeInfo = false, infoText }, ref) => {
      ...
      <>
        {propName && (
          <div className="flex items-center mb-1" ref={parentRef}>
            ...
            <InfoButton visible={includeInfo} toggleInfo={toggleInfo} parentRef={parentRef} iconSize={0.7} />
          </div>
        )}
